...
<div id="login-modal" class="modal">
    <form class="modal-content animate" action="{{ route('login') }}" method="post">
        ...
        <div class="container">
            ...
            <input id="username" type="username" placeholder="Enter Username" class="form-control @error('username') is-invalid @enderror mb-4" name="username" value="{{ old('username') }}" required autocomplete="username" autofocus>
                @error('username')
            ...
            <input id="password" type="password" placeholder="Enter Password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
                ...
                @enderror
            <input type="checkbox" onclick="showPassword()" class="mr-2 my-1" style="height:20px;width:20px">Show Password
